        ...
        return (
            <KeyboardAvoidingView style = {styles.container} behavior="padding">
                    ...
                    <View style = {{alignSelf: "stretch", marginHorizontal: 32}}>
                            <Text style = {styles.title}> Chỉnh sửa Danh Sách </Text>

                            <TextInput style = {styles.input} placeholder = "Tên thay đổi ?" onChangeText = {Text => this.setState({name : Text})}/>
                            ...
                            <TouchableOpacity style = {[styles.create, {backgroundColor: this.state.color}]} onPress ={this.createTodo} >
                                    <Text style = {{color: colors.white, fontWeight: "600"}}> Chỉnh sửa </Text>
                            </TouchableOpacity>
                    </View>
